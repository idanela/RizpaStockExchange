...
public class XmlRizpaDataExtractor {
   ...
   public static  RizpaStockExchangeDescriptor getStocks(String path)
   {
   ...
   public static boolean checkIfContentIsValid(RizpaStockExchangeDescriptor rsed)
   {   Map<String,String> companyNames = new HashMap<>();
       ...
       {
            if(mapStocks.containsKey(stock.getRseSymbol()) || companyNames.containsKey(stock.getRseCompanyName()))
            {
                isValidFormat = false;
                break;
            }

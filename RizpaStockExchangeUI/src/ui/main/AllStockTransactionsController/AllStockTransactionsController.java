...
public class AllStockTransactionsController implements Initializable {
        ...
        @FXML private TableColumn<TransactionMade, String> transactionsMadeBuyerCol;
        @FXML private TableColumn<TransactionMade, String> transactionsMadeSellerCol;
        @FXML private TableColumn<TransactionMade, String> transactionsMadeInitiatorCol;
        ...
        public void initialize(URL location, ResourceBundle resources) {
                ...
                transactionsMadeBuyerCol.setCellValueFactory(new PropertyValueFactory<TransactionMade,String>("buyerName"));
                transactionsMadeSellerCol.setCellValueFactory(new PropertyValueFactory<TransactionMade,String>("SellerName"));
                transactionsMadeInitiatorCol.setCellValueFactory(new PropertyValueFactory<TransactionMade,String>("userName"));

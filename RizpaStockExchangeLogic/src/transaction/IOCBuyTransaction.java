...
public class IOCBuyTransaction extends IOCTransaction{
    public IOCBuyTransaction() {
        super();
    }

    public IOCBuyTransaction(Stock m_Stock, int m_Limit, int m_NumOfStocks, User initiator, String kind) {
